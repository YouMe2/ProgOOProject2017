...
public class Sound {
	...
	public static final Sound ping = new Sound("/pickup.wav"); // creates a sound
																 // from
																 // pickup.wav
																 // file
	...
	public static final Sound playerHurt = new Sound("/playerhurt.wav"); // creates
																		 ...
																		 // playerhurt.wav
																		 // file
	public static final Sound playerDeath = new Sound("/death.wav"); // creates a
																	 // sound
																	 // from
																	 // death.wav
																	 // file
	...
	public static final Sound bossdeath = new Sound("/bossdeath.wav"); // creates
																		 ...
																		 // bossdeath.wav
																		 // file
	public static final Sound craft = new Sound("/craft.wav"); // creates a sound
																 // from
																 // craft.wav
																 // file
	...
	private Sound(String name) {
		try {
			clip = Applet.newAudioClip(Sound.class.getResource(name)); // tries
																		 // to
																		 // load
																		 // the
																		 // audio
