...
public class Particle extends GameComponent implements Destroyable{
	...
	public Particle(int x, int y, int w, int h, Image[] his, Image[] lows, int dtime) {
		super(x, y, w, h);
		PARTICLES.add(this);
		...
		view = new Viewable() {
			...
			public void renderLOW(Graphics gr) {
				...
				gr.drawImage(imgsLOW[counter], getX(), getY(), getWidth(), getHeight(), null);		
			}
			
			@Override
			public void render(Graphics gr) {
				
				gr.drawImage(imgsHI[counter], getX(), getY(), getWidth(), getHeight(), null);					
